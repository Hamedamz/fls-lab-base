<template>
  <div>
    <h1 class="mb-8 text-4xl font-black text-white">Personnel</h1>

    <div class="tab-content-container"> <!-- Unique class for Personnel tab content -->
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div v-for="group in personnelGroups" :key="group.title">
          ...
          <div class="grid gap-4">
            <div v-for="person in group.items" :key="person.name" class="bg-gray-800 p-6 rounded-lg shadow-md">
